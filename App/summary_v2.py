...
class Summary():
    ...
    """
    def __init__(self):
        self.text_max_len = 45
        self.summary_max_len = 13

        self.src_vocab = 18000
        # loading src tokenizer
        with open('APP/Data/src_tokenizer_v2.pickle', 'rb') as handle:
            self.src_tokenizer = pickle.load(handle)

        self.tar_vocab = 9000
        # loading tar tokenizer
        with open('APP/Data/tar_tokenizer_v2.pickle', 'rb') as handle:
